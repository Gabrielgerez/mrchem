...
json HigherResponseSolver::optimize(double omega, Molecule &mol, FockOperator &F_0, FockOperator &F_1) {
    ...
    RankZeroOperator V_1 = F_1.potential(); // assume infinitesimal perturbation, the pertubation operator drops out here
...
void HigherResponseSolver::printProperty() const {
...
void HigherResponseSolver::printParameters(double omega, const std::string &oper) const {
